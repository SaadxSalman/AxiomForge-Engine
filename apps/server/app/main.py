# -*- coding: utf-8 -*-
"""AxiomForge-Engine application entry point.

Wires together the FastAPI application, background task queues (Celery), the
WebSocket streaming endpoint and the lifespan lifecycle (Weaviate schema
initialisation + graceful driver teardown).
"""
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    yield
    try:
        from app.database import _neo4j_driver, _weaviate_client
